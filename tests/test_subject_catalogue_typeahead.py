...
def test_current_typeahead_bundle_uses_the_cache_busted_asset_basename():
    ...
    assert "library-main-0-1-0-alpha-174-recently-opened" in controller
    assert "library-vue-0-1-0-alpha-174-recently-opened" in controller
    assert 'data-library-main-script="library-main-0-1-0-alpha-174-recently-opened"' in template
