...
def test_cache_busting_version_bumped_for_compact_card_fix():
    ...
    assert "<version>0.1.0-alpha.73</version>" in info
    assert '"version": "0.1.0-alpha.73"' in package
    assert '"version": "0.1.0-alpha.73"' in lock
...
def test_smoke_requires_compact_card_default_and_version_marker():
    ...
    assert "app_version=0.1.0-alpha.73" in smoke
