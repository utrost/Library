...
def test_alpha_158_version_assets_and_release_language_are_aligned():
    ...
    assert '"version": "0.1.0-alpha.173"' in read("package-lock.json")
    page = read("lib/Controller/PageController.php")
    assert "library-main-0-1-0-alpha-173-cover-help-tooltip" in page
    assert "library-vue-0-1-0-alpha-173-cover-help-tooltip" in page
