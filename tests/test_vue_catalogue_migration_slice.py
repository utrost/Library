...
def test_page_controller_provides_catalogue_initial_state_and_loads_vue_entrypoint():
    ...
    assert "private const VUE_SCRIPT_ASSET = 'library-main-0-1-0-alpha-174-recently-opened';" in controller
    assert "private const VUE_STYLE_ASSET = 'library-vue-0-1-0-alpha-174-recently-opened';" in controller
