...
def test_import_health_actions_menu_is_compact_by_default():
    app = (ROOT / "src" / "App.vue").read_text()

    actions_start = app.index("<details class=\"library-catalogue-actions-menu\" @toggle=\"loadImportHealthSummary\">")
