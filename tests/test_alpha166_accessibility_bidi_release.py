...
def test_alpha166_version_sources_and_unpackage_boundary():
    ...
    assert "library-main-0-1-0-alpha-171-typeaheads" in read("lib/Controller/PageController.php")
    assert "library-vue-0-1-0-alpha-171-typeaheads" in read("lib/Controller/PageController.php")
