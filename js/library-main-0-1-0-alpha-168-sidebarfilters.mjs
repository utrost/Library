...
`, lC = { class: "vue-skip-actions__container" }, cC = { class: "vue-skip-actions__headline" }, uC = { class: "vue-skip-actions__buttons" }, dC = /* @__PURE__ */ xt({
  ...
  setup(e) {
    ...
    }), u = /* @__PURE__ */ $t((d.items || []).map((y) => ({ ...y }))), h = q(() => u), S = q(() => d.shelves || []), E = q(() => d.formats || []), O = q(() => d.publicationTypes?.length ? d.publicationTypes : n), A = q(() => d.publishers || []), L = q(() => d.publications || []), R = q(() => d.publicationIssueContext || null), M = q(() => d.scanStatuses || []), G = q(() => d.workflowStatuses || []), F = q(() => d.genres || []), le = q(() => d.classifications || []), ne = q(() => d.cataloguePagination || {
      page: 1,
      limit: 100,
          ...
          footer: Oe(() => [
            c("section", EC, [
              ...
              c("form", {
                ...
                c("label", null, [
                  Ne(p(g(m)("library", "Genre")), 1),
                  We(c("select", {
                    "onUpdate:modelValue": _[20] || (_[20] = (f) => P.genre = f),
                    name: "genre"
                  }, [
                    c("option", hT, p(g(m)("library", "All genres")), 1),
                      ...
                      c("form", {
                        ...
                        c("label", null, [
                          ...
                          c("select", S2, [
                            ...
                            c("option", x2, p(g(m)("library", "Genres")), 1),
