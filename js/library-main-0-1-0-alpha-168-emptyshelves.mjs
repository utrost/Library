...
`, rC = { class: "vue-skip-actions__container" }, sC = { class: "vue-skip-actions__headline" }, oC = { class: "vue-skip-actions__buttons" }, lC = /* @__PURE__ */ xt({
...
}, IA = ["title"], PA = ["action", "title"], DA = ["value"], MA = ["value"], $A = ["placeholder", "disabled"], FA = ["disabled", "title"], zA = ["aria-label"], UA = ["href"], BA = ["action"], HA = ["value"], jA = {
  type: "submit",
  class: "button tertiary"
}, VA = ["aria-label"], GA = { class: "library-workspace-panel-summary library-workspace-panel-summary--polished" }, KA = ["title"], WA = { class: "library-workspace-panel-purpose" }, qA = { class: "library-workspace-scope-badge" }, YA = { "aria-live": "polite" }, XA = ["action"], ZA = ["value"], JA = ["placeholder"], QA = ["title"], e2 = ["action"], t2 = ["value"], n2 = ["placeholder"], i2 = ["title"], a2 = ["action"], r2 = ["value"], s2 = ["name", "value"], o2 = ["title"], l2 = ["action"], c2 = ["value"], u2 = ["name", "value"], d2 = { name: "bulkEditField" }, f2 = { value: "publicationType" }, h2 = { value: "subtitle" }, p2 = { value: "creators" }, v2 = { value: "publication" }, g2 = { value: "publicationDate" }, m2 = { value: "language" }, b2 = { value: "publisher" }, y2 = { value: "genres" }, _2 = { value: "classifications" }, w2 = ["placeholder"], S2 = ["title"], C2 = ["action"], T2 = ["value"], E2 = ["name", "value"], A2 = ["title"], k2 = {
  key: 0,
...
}, L2 = { class: "library-muted library-catalogue-eyebrow" }, R2 = ["title"], I2 = ["aria-label"], P2 = { key: 0 }, D2 = { key: 1 }, M2 = { key: 2 }, $2 = ["aria-label"], F2 = { key: 0 }, z2 = { key: 1 }, U2 = {
  key: 1,
  class: "library-publication-issue-groups",
  "aria-labelledby": "library-publication-issue-groups-heading"
}, B2 = { class: "library-muted library-catalogue-eyebrow" }, H2 = ["title"], j2 = ["aria-label"], V2 = ["href"], G2 = {
  key: 0,
  class: "library-notice"
}, K2 = { class: "library-publication-issue-label" }, W2 = ["href"], q2 = { class: "library-muted" }, Y2 = {
  key: 1,
  class: "library-publication-unknown-issues"
}, X2 = ["title"], Z2 = ["href"], J2 = { class: "library-catalogue-status-row" }, Q2 = { class: "library-muted library-filter-result-summary" }, ek = { key: 0 }, tk = { href: "?" }, nk = ["aria-label"], ik = { class: "library-pagination-range" }, ak = { key: 0 }, rk = ["href"], sk = {
  key: 1,
  class: "library-muted"
}, ok = ["href"], lk = {
  key: 3,
  class: "library-muted"
}, ck = ["aria-label"], uk = ["href", "aria-label", "onClick"], dk = ["title"], fk = { class: "library-empty-actions" }, hk = ["href"], pk = { class: "library-muted" }, vk = ["title"], gk = { class: "library-empty-actions" }, mk = ["href"], bk = ["title"], yk = { class: "library-empty-actions" }, _k = ["href"], wk = {
  href: "?",
  class: "button primary"
}, Sk = ["title"], Ck = { class: "library-empty-actions" }, Tk = ["href"], Ek = {
  key: 6,
...
}, Ok = { class: "library-item-selection" }, Nk = ["checked", "aria-label", "onChange"], xk = { class: "library-catalogue-list-main" }, Lk = ["onClick"], Rk = {
  class: "library-bidi-human",
  dir: "auto"
}, Ik = {
  key: 0,
  ...
  class: "library-bidi-human",
  dir: "auto"
}, Dk = { class: "library-catalogue-list-metadata" }, Mk = { key: 0 }, $k = {
  class: "library-bidi-human",
  dir: "auto"
}, Fk = { key: 1 }, zk = { key: 2 }, Uk = ["dir"], Bk = { key: 3 }, Hk = {
  class: "library-bidi-human",
  dir: "auto"
}, jk = { class: "library-catalogue-list-actions" }, Vk = ["href"], Gk = ["onClick"], Kk = { class: "library-item-selection" }, Wk = ["checked", "aria-label", "onChange"], qk = ["aria-labelledby", "aria-expanded", "onClick"], Yk = ["id"], Xk = { class: "library-cover-frame" }, Zk = {
  key: 0,
  class: "library-cover-loading-shimmer",
  "aria-hidden": "true"
}, Jk = ["src", "onLoad", "onError"], Qk = {
  key: 1,
  class: "library-cover-fallback",
  role: "status"
}, eO = ["action", "onSubmit"], tO = ["value"], nO = ["value"], iO = ["aria-pressed", "title", "aria-label", "aria-busy", "disabled", "onClick"], aO = ["data-library-star-error"], rO = { class: "library-cover-summary" }, sO = { class: "library-cover-primary" }, oO = ["id"], lO = ["onClick"], cO = {
  class: "library-bidi-human",
  dir: "auto"
}, uO = {
  key: 0,
  ...
  class: "library-bidi-human",
  dir: "auto"
}, mO = { class: "library-cover-primary-actions" }, bO = ["href"], yO = ["aria-label"], _O = { class: "library-pagination-range" }, wO = { key: 0 }, SO = ["href"], CO = {
  key: 1,
  class: "library-muted"
}, TO = ["href"], EO = {
  key: 3,
  class: "library-muted"
}, AO = { class: "library-sidebar-content" }, kO = {
  key: 0,
  class: "library-muted",
  role: "status",
  "aria-live": "polite"
  ...
  class: "hidden-visually"
}, xO = { class: "library-sidebar-publication-header" }, LO = {
  id: "library-detail-drawer-cover-label",
  class: "hidden-visually"
}, RO = ["src"], IO = { class: "library-sidebar-publication-summary" }, PO = { class: "library-muted library-catalogue-eyebrow" }, DO = {
  class: "library-bidi-human",
  dir: "auto"
}, MO = { key: 0 }, $O = {
  class: "library-bidi-machine",
  dir: "ltr"
}, FO = { class: "library-detail-drawer-actions" }, zO = ["href"], UO = ["aria-label"], BO = ["aria-current", "onClick"], HO = {
  key: 0,
  class: "library-sidebar-section",
  "aria-labelledby": "library-sidebar-overview-heading"
}, jO = { id: "library-sidebar-overview-heading" }, VO = {
  key: 0,
  class: "library-sidebar-description"
}, GO = {
  class: "library-bidi-human",
  dir: "auto"
}, KO = { class: "library-detail-drawer-facts" }, WO = { key: 0 }, qO = { key: 1 }, YO = { key: 2 }, XO = { key: 3 }, ZO = { key: 4 }, JO = {
  key: 1,
  class: "library-sidebar-section",
  "aria-labelledby": "library-sidebar-metadata-heading"
}, QO = { id: "library-sidebar-metadata-heading" }, eN = ["placeholder"], tN = ["onUpdate:modelValue", "aria-label", "placeholder"], nN = ["onUpdate:modelValue", "aria-label"], iN = ["onClick"], aN = { class: "library-muted" }, rN = {
  key: 0,
  role: "alert"
}, sN = {
  key: 1,
...
}, cN = { id: "library-sidebar-suggestions-heading" }, uN = { class: "library-muted" }, dN = {
  key: 2,
  class: "library-sidebar-section",
  "aria-labelledby": "library-sidebar-activity-heading"
}, fN = { id: "library-sidebar-activity-heading" }, hN = { class: "library-detail-drawer-facts" }, pN = { key: 0 }, vN = { key: 1 }, gN = { key: 2 }, mN = { dir: "ltr" }, bN = ["aria-label"], yN = ["disabled"], _N = ["disabled"], wN = 20, SN = "/apps/library", CN = 2147483647, TN = {
  __name: "App",
  props: {
    state: {
      type: Object,
  ...
  setup(e) {
    ...
    const ce = /* @__PURE__ */ qe(P.publication), X = /* @__PURE__ */ qe(!1), ae = /* @__PURE__ */ qe(null), me = q(() => {
      ...
      return (_ !== "" && ae.value !== null ? ae.value : L.value).filter((f) => _ === "" || f.toLocaleLowerCase().includes(_)).slice(0, wN);
    });
    vt(() => P.publication, (_) => {
      ce.value = _ || "";
    });
    ...
    const at = Object.fromEntries(Object.keys(P).map((_) => [_, _ === "sort" ? "title" : _ === "view" ? "compact" : ""])), ln = window.location.pathname.indexOf(SN), U = ln >= 0 ? window.location.pathname.slice(0, ln) : "", v = {
    ...
    function W() {
      ...
      const b = Number(_[0]);
      return Number.isSafeInteger(b) && b <= CN ? b : null;
    }
              ...
              V.value ? (w(), T("section", fC, [
                ...
                c("nav", {
                  ...
                  Yt.value.length > 0 ? (w(), T("details", {
                    ...
                    c("summary", GA, [
                      ...
                      c("small", WA, p(g(m)("library", "Batch actions for selected publications")), 1),
                      c("b", qA, p(g($n)("library", "%n publication selected", "%n publications selected", Yt.value.length)), 1)
                    ]),
                    c("p", YA, p(g($n)("library", "%n publication selected", "%n publications selected", Yt.value.length)), 1),
                    c("div", {
                      ...
                      c("form", {
                        ...
                        c("button", {
                          ...
                          class: "button secondary",
                          title: g(m)("library", "Batch actions for selected publications")
                        }, p(g(m)("library", "Reset metadata")), 9, o2)
                      ], 8, a2),
                      c("form", {
                        method: "post",
                        action: Kn.value,
                        ...
                        c("label", null, [
                          ...
                          c("select", d2, [
                            c("option", f2, p(g(m)("library", "Publication type")), 1),
                            c("option", h2, p(g(m)("library", "Subtitle")), 1),
                            c("option", p2, p(g(m)("library", "Creators")), 1),
                            c("option", v2, p(g(m)("library", "Series / periodical")), 1),
                            c("option", g2, p(g(m)("library", "Publication date")), 1),
                            c("option", m2, p(g(m)("library", "Language")), 1),
                            c("option", b2, p(g(m)("library", "Publisher")), 1),
                            c("option", y2, p(g(m)("library", "Genres")), 1),
                            c("option", _2, p(g(m)("library", "Classifications")), 1)
                          ])
                        ]),
                        c("label", null, [
                        ...
                        }, p(g(m)("library", "Preview edit")), 9, S2)
                      ], 8, l2),
                      c("form", {
                        method: "post",
                        action: ut.value,
                        ...
                        c("button", {
                          ...
                          class: "button secondary",
                          title: g(m)("library", "Batch actions for selected publications")
                        }, p(g(m)("library", "Fresh covers")), 9, A2)
                      ], 8, C2)
                    ], 32)
                  ], 8, VA)) : H("", !0)
                ], 8, wE),
                Xn.value ? (w(), T("p", k2, p(Xn.value), 1)) : H("", !0),
                Ea.value ? (w(), T("p", O2, p(Ea.value), 1)) : H("", !0),
                Qt.value ? (w(), T("p", N2, p(Qt.value), 1)) : H("", !0),
                Gi.value ? (w(), T("section", x2, [
                  c("p", L2, p(Ja.value), 1),
                  c("h3", {
                  ...
                  c("div", {
                    ...
                    R.value?.earliestYear && R.value?.latestYear ? (w(), T("span", P2, p(R.value.earliestYear) + "–" + p(R.value.latestYear), 1)) : H("", !0),
                    R.value?.datedCount ? (w(), T("span", D2, p(R.value.datedCount) + " " + p(g(m)("library", "dated")), 1)) : H("", !0),
                    R.value?.undatedCount > 0 ? (w(), T("span", M2, p(R.value.undatedCount) + " " + p(g(m)("library", "undated")), 1)) : H("", !0)
                  ], 8, I2),
                  Wn.value && R.value ? (w(), T("aside", {
                    ...
                    R.value.earliestYear && R.value.latestYear ? (w(), T("span", F2, p(R.value.earliestYear) + "–" + p(R.value.latestYear), 1)) : H("", !0),
                    c("span", null, p(R.value.datedCount) + " " + p(g(m)("library", "with issue/date coverage")), 1),
                    R.value.undatedCount > 0 ? (w(), T("span", z2, p(R.value.undatedCount) + " " + p(g(m)("library", "without dates yet")), 1)) : H("", !0),
                    c("span", null, p(g(m)("library", "read-only grouping")), 1)
                  ], 8, $2)) : H("", !0),
                  Wn.value && R.value?.issueGroups?.length ? (w(), T("section", U2, [
                    c("div", null, [
                      c("p", B2, p(g(m)("library", "Issue order")), 1),
                      c("h4", {
                      ...
                      }, p(g(m)("library", "Read-only issue/date grouping")), 9, H2)
                    ]),
                    c("div", {
                    ...
                    R.value.gapRanges?.length ? (w(), T("p", G2, p(g(m)("library", "Gap")) + ": " + p(R.value.gapRanges.join(", ")), 1)) : H("", !0),
                    ...
                    R.value.unknownIssueItems?.length ? (w(), T("details", Y2, [
                      c("summary", {
                        title: g(m)("library", "Unknown issue/date rows remain visible instead of disappearing from the publication page.")
                      }, p(g(m)("library", "Unknown issue/date")) + " · " + p(R.value.unknownIssueItems.length), 9, X2)
                    ])) : H("", !0)
                  ])) : H("", !0),
                  c("p", null, [
                    c("a", {
                ...
                c("div", J2, [
                  ...
                  c("nav", {
                    ...
                    c("span", ik, [
                      Oe(p(g(m)("library", "Page")) + " " + p(ne.value.page), 1),
                      ne.value.total > 0 ? (w(), T("span", ak, " · " + p(ne.value.from) + "–" + p(ne.value.to), 1)) : H("", !0)
                    ]),
                    ne.value.previousUrl ? (w(), T("a", {
                      key: 0,
                      href: ne.value.previousUrl
                    }, p(g(m)("library", "Previous")), 9, rk)) : (w(), T("span", sk, p(g(m)("library", "Previous")), 1)),
                    ne.value.nextUrl ? (w(), T("a", {
                      key: 2,
                      href: ne.value.nextUrl
                    }, p(g(m)("library", "Next")), 9, ok)) : (w(), T("span", lk, p(g(m)("library", "Next")), 1))
                  ], 8, nk)
                ]),
                ...
                h.value.length === 0 ? (w(), T("div", {
                  ...
                  Ca.value ? (w(), T(he, { key: 0 }, [
                    ...
                    }, p(g(m)("library", "Start with one Library root")), 9, dk),
                    c("p", fk, [
                      c("a", {
                        href: k.value,
                        class: "button primary"
                      }, p(g(m)("library", "Add a Library root")), 9, hk),
                      c("span", pk, p(g(m)("library", "Run a scan after saving a root")), 1)
                    ])
                    ...
                    }, p(g(m)("library", "No enabled Library roots")), 9, vk),
                    c("p", gk, [
                      c("a", {
                        href: k.value,
                        class: "button primary"
                      }, p(g(m)("library", "Open Library settings")), 9, mk)
                    ])
                  ], 64)) : Ki.value ? (w(), T(he, { key: 2 }, [
                    c("h3", {
                      title: g(m)("library", "Try a broader search, remove one active chip, or clear every catalogue filter.")
                    }, p(g(m)("library", "No matches for the current filters")), 9, bk),
                    c("p", yk, [
                      c("a", {
                        href: ov(),
                        class: "button secondary"
                      }, p(g(m)("library", "Clear search")), 9, _k),
                      c("a", wk, p(g(m)("library", "Clear all filters")), 1)
                    ])
                  ], 64)) : (w(), T(he, { key: 3 }, [
                    c("h3", {
                      title: g(m)("library", "Run a scan from settings to index enabled roots. Source files stay in Nextcloud Files.")
                    }, p(g(m)("library", "No catalogue items yet")), 9, Sk),
                    c("p", Ck, [
                      c("a", {
                        href: k.value,
                        class: "button primary"
                      }, p(g(m)("library", "Run a scan from settings")), 9, Tk)
                    ])
                  ], 64))
                ], 2)) : H("", !0),
                h.value.length > 0 ? (w(), T("label", Ek, [
                  c("input", {
                    type: "checkbox",
                ...
                h.value.length > 0 && jt.value === "list" ? (w(), T("ul", kk, [
                  (w(!0), T(he, null, Fe(h.value, (f) => (w(), T("li", {
                    ...
                    c("div", jk, [
                      c("a", {
                        class: "button primary",
                        href: f.openUrl
                      }, p(g(m)("library", "Open")), 9, Vk),
                      c("button", {
                        type: "button",
                        class: "button secondary",
                        onClick: (B) => ye(f, B)
                      }, p(g(m)("library", "Details")), 9, Gk)
                    ])
                  ], 2))), 128))
                ])) : h.value.length > 0 ? (w(), T("div", {
                  key: 8,
                  ...
                  (w(!0), T(he, null, Fe(h.value, (f) => (w(), T("article", {
                    ...
                    c("button", {
                      ...
                      c("span", Xk, [
                        ...
                        rr(f) === "error" ? (w(), T("span", Qk, p(g(m)("library", "Cover unavailable")), 1)) : H("", !0)
                      ])
                    ], 8, qk),
                    c("form", {
                      method: "post",
                      ...
                      c("div", sO, [
                        c("h3", {
                          ...
                          c("button", {
                            ...
                            c("bdi", cO, p(f.title), 1)
                          ], 8, lO)
                        ], 8, oO),
                        f.creators ? (w(), T("p", uO, [
                          c("bdi", dO, p(f.creators), 1)
                        ])) : H("", !0),
                        _l(f) || f.extension ? (w(), T("div", fO, [
                          f.extension ? (w(), T("span", hO, [
                            c("bdi", pO, p(ar(f.extension)), 1)
                          ])) : H("", !0),
                          _l(f) ? (w(), T("p", vO, [
                            c("bdi", gO, p(_l(f)), 1)
                          ])) : H("", !0)
                ...
                h.value.length > 0 ? (w(), T("nav", {
                  ...
                  c("span", _O, [
                    Oe(p(g(m)("library", "Page")) + " " + p(ne.value.page), 1),
                    ne.value.total > 0 ? (w(), T("span", wO, " · " + p(ne.value.from) + "–" + p(ne.value.to), 1)) : H("", !0)
                  ]),
                  ne.value.previousUrl ? (w(), T("a", {
                    key: 0,
                    href: ne.value.previousUrl
                  }, p(g(m)("library", "Previous")), 9, SO)) : (w(), T("span", CO, p(g(m)("library", "Previous")), 1)),
                  ne.value.nextUrl ? (w(), T("a", {
                    key: 2,
                    href: ne.value.nextUrl
                  }, p(g(m)("library", "Next")), 9, TO)) : (w(), T("span", EO, p(g(m)("library", "Next")), 1))
                ], 8, yO)) : H("", !0)
              ]))
            ], 8, dC)
          ]),
        ...
        we(g(WS), {
          ...
          default: ke(() => [
            c("div", AO, [
              ...
              dt.loading && !Se.value ? (w(), T("p", kO, p(g(m)("library", "Loading publication details…")), 1)) : dt.error ? (w(), T("div", {
                key: 1,
              ...
              ], 8, OO)) : Se.value ? (w(), T(he, { key: 2 }, [
                c("p", NO, p(g(m)("library", "Escape closes; arrow keys browse neighbouring visible items.")), 1),
                c("div", xO, [
                  c("span", LO, p(g(m)("library", "Cover for")), 1),
                  c("img", {
                  ...
                  c("div", IO, [
                    c("p", PO, [
                      c("bdi", DO, p(Se.value.publicationType || g(m)("library", "Publication")), 1),
                      Se.value.extension ? (w(), T("span", MO, [
                        b[42] || (b[42] = Oe(" · ", -1)),
                        c("bdi", $O, p(ar(Se.value.extension)), 1)
                      ])) : H("", !0)
                    ]),
                    c("div", FO, [
                      c("a", {
                ...
                c("nav", {
                  ...
                  }, p(g(m)("library", f.label)), 11, BO)), 64))
                ], 8, UO),
                Vt.value === "overview" ? (w(), T("section", HO, [
                  c("h3", jO, p(g(m)("library", "Overview")), 1),
                  Se.value.description ? (w(), T("p", VO, [
                    c("bdi", GO, p(Se.value.description), 1)
                  ])) : H("", !0),
                  c("dl", KO, [
                    Se.value.publication ? (w(), T("div", WO, [
                      c("dt", null, p(g(m)("library", "Series")), 1),
                      c("dd", null, p(Se.value.publication), 1)
                    ])) : H("", !0),
                    Se.value.publicationDate ? (w(), T("div", qO, [
                      c("dt", null, p(g(m)("library", "Date")), 1),
                      c("dd", null, p(Se.value.publicationDate), 1)
                    ])) : H("", !0),
                    Se.value.publisher ? (w(), T("div", YO, [
                      c("dt", null, p(g(m)("library", "Publisher")), 1),
                      c("dd", null, p(Se.value.publisher), 1)
                    ])) : H("", !0),
                    Se.value.language ? (w(), T("div", XO, [
                      c("dt", null, p(g(m)("library", "Language")), 1),
                      c("dd", null, p(Se.value.language), 1)
                    ])) : H("", !0),
                    Se.value.shelf ? (w(), T("div", ZO, [
                      c("dt", null, p(g(m)("library", "Shelf")), 1),
                      c("dd", null, p(Se.value.shelf), 1)
                    ])) : H("", !0)
                  ])
                ])) : Vt.value === "metadata" ? (w(), T("section", JO, [
                  c("h3", QO, p(g(m)("library", "Metadata")), 1),
                  c("form", {
                    ...
                    c("p", aN, p(g(m)("library", "Creator, publisher, language, and other fields remain available in Maintenance while sidebar editing expands.")), 1),
                    en.error ? (w(), T("p", rN, p(en.error), 1)) : en.saved ? (w(), T("p", sN, p(g(m)("library", "Metadata saved.")), 1)) : H("", !0),
                    c("button", {
                      type: "submit",
                      class: "button primary",
                      disabled: en.saving
                    }, p(en.saving ? g(m)("library", "Saving…") : g(m)("library", "Save metadata")), 9, oN)
                  ], 32),
                  Z(Se.value).length ? (w(), T("section", lN, [
                    c("h4", cN, p(g(m)("library", "Scanner suggestions")), 1),
                    c("p", uN, p(g(m)("library", "Suggestions are optional and never replace your edits automatically.")), 1),
                    c("dl", null, [
                ...
                c("nav", {
                  ...
                  }, p(g(m)("library", "Previous item")), 9, yN),
                  c("button", {
                    type: "button",
                    class: "button secondary",
                    disabled: !xa.value,
                    onClick: b[33] || (b[33] = (f) => ft(xa.value))
                  }, p(g(m)("library", "Next item")), 9, _N)
                ], 8, bN)
              ], 64)) : H("", !0)
            ])
          ]),
...
try {
  ...
  Qm(TN, { state: n }).mount(t), window.LibraryStartupWatchdog?.mounted();
} catch (e) {
  EN(), console.error("[library] Vue startup failed", e);
}
