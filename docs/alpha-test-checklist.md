...
Use this Public alpha checklist before the v0.1 alpha test pass on `0.1.0-alpha.144` and for early tester feedback. For the full repeatable script, use the [human test handbook](human-test-handbook.md).
