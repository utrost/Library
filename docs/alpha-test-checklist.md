...
Use this Public alpha checklist before Uwe's v0.1 manual test pass on `0.1.0-alpha.139` and for early tester feedback. For the full repeatable script, use the [human test handbook](human-test-handbook.md).
