...
6. Add discovery by publication structure. Search/filter/pagination, built-in **Useful views** with daily/cleanup smart collections and count badges, the first dedicated publication discovery page, publication contents issue/date context, the first dedicated publication year discovery page and the first dedicated creator discovery page exist; richer grouping and optional user-defined saved-view persistence do not.
...
7. **Discovery by publication structure** — search/filter, creator/publication/year filters, active chips, top-series shortcuts, built-in **Useful views** with daily/cleanup smart collections and count badges, the first dedicated publication discovery page, the first dedicated publication year discovery page and the first dedicated creator discovery page exist; richer creator identity splitting, publication grouping and optional user-defined saved-view persistence remain future work.
