...
4. Add repair-oriented scan lifecycle controls. Queued scans, progress, added, moved/renamed, unchanged, missing and metadata-error counts, post-scan **Changes found** review links, metadata-error retry, **Recheck missing files**, **Cancel queued scan** and cooperative running-job cancellation work; scheduled scans and completion notifications do not.
