...
6. Add discovery by publication structure. Search/filter/pagination, built-in **Useful views**, the first dedicated publication discovery page, publication contents issue/date context, the first dedicated publication year discovery page and the first dedicated creator discovery page exist; richer grouping and user-defined saved views do not.
