...
4. **P3 — Scan lifecycle repair controls.** Queued per-root scans and progress/history exist, and metadata-error retry works from Library settings. Missing pieces are check missing files, cancellation, scheduled/resumable scans and completion/failure notifications.
