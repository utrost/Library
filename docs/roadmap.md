...
- Scan-job progress/history table and UI summary for the latest queued background scan: auto-refreshing scan progress and live-ish scan progress, status, root count, indexed file count, error count and duration.
