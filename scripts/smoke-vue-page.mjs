...
try {
  ...
  if (!token) {
    ...
    console.log(`source_has_filename_path_search_copy=${sourceComponent.includes('Search title, creator, description, filename or folder') && sourceComponent.includes('Descriptions, filename and folder names are searchable')}`)
    ...
    console.log(`app_version=0.1.0-alpha.141`)
    ...
    console.log(`source_has_compact_cover_cards_all_widths=${appInfo.includes('<version>0.1.0-alpha.141</version>') && sourceComponent.includes('library-cover-details') && sourceComponent.includes('Show details and actions') && sourceStyle.split('@media (max-width: 520px)', 1)[0].includes('grid-template-columns: repeat(auto-fill, minmax(120px, 1fr))') && sourceStyle.split('@media (max-width: 520px)', 1)[0].includes('min-height: 0')}`)
    ...
    console.log(`source_has_detail_drawer=${sourceComponent.includes('library-detail-drawer') && sourceComponent.includes('selectedDrawerItem') && sourceComponent.includes('Close details panel') && sourceComponent.includes('View full details')}`)
    ...
    console.log(`source_has_gallery_shelf_view_modes=${sourceComponent.includes('library-view-mode-toggle') && sourceComponent.includes('Compact / Gallery / Shelf') && sourceComponent.includes('library-cover-gallery--gallery') && sourceComponent.includes('library-cover-gallery--shelf') && sourceComponent.includes("setViewMode('gallery')") && sourceComponent.includes("setViewMode('shelf')")}`)
