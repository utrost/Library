...
try {
  ...
  if (!token) {
    ...
    const installedVersionAssetIdentity = scriptMatch?.[1]?.includes('0-1-0-alpha-173') && cssMatch?.[1]?.includes('0-1-0-alpha-173')
    ...
    console.log(`app_version=${installedVersionAssetIdentity ? '0.1.0-alpha.173' : 'unverified'}`)
