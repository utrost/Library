...
try {
  ...
  if (!token) {
    ...
    const installedVersionAssetIdentity = scriptMatch?.[1]?.includes('0-1-0-alpha-174') && cssMatch?.[1]?.includes('0-1-0-alpha-174')
    ...
    console.log(`app_version=${installedVersionAssetIdentity ? '0.1.0-alpha.174' : 'unverified'}`)
    ...
    console.log(`source_has_compact_list_view_modes=${bundleHas('library-view-mode-toggle', 'library-cover-gallery--compact', 'data-library-catalogue-list')}`)
