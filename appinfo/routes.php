...
return [
    'routes' => [
        ...
        ['name' => 'page#classificationSuggestions', 'url' => '/catalogue/classification-suggestions', 'verb' => 'GET'],
        ['name' => 'page#tagSuggestions', 'url' => '/catalogue/tag-suggestions', 'verb' => 'GET'],
        ...
        ['name' => 'health#refreshImportSummary', 'url' => '/health/import-summary', 'verb' => 'POST'],
        ...
        ['name' => 'health#coverProbe', 'url' => '/health/covers/probe', 'verb' => 'POST'],
        ...
        ['name' => 'item#recordOpen', 'url' => '/items/{itemId}/open', 'verb' => 'POST'],
