...
- manually scan all enabled roots for the current user through a queued background scan and record scan-job status, counts, duration and summary for progress/history visibility;
