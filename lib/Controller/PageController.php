...
class PageController extends Controller {
    ...
    private const VUE_SCRIPT_ASSET = 'library-main-0-1-0-alpha-174-collections-title2bdi-x';
    private const VUE_STYLE_ASSET = 'library-vue-0-1-0-alpha-174-collections-title2bdi-x';
